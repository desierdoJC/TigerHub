               ...
               <div class="signUpBox">
                    ...
                    <form action="signupServlet.do" method="POST">
                        <div class ="fName">
                            ...
                            <input type="text" class="flName" name="fnSU">
                        </div>
                        <div class ="lName">
                            <label class = "unpwLabel">Last Name</label><br>
                            <input type="text" class="flName" name="lnSU">
                        </div>
                        <br>
                        <label class = "unpwLabel">Email Address</label><br>
                        <input type="text" class="userpass" name="emailSU" >
                        <br><br>
                        <label class = "unpwLabel">Password</label><br>
                        <input type="password" class="userpass" name="pwSU">
                        <br><br>
                        <label class = "unpwLabel">Confirm Password</label><br>
                        <input type="password" class="userpass" name="cpwSU">
                        <br><br>
                        ...
                        <button class ="loginBT">Sign Up</button>
                    </form>
                </div>
            </div>
